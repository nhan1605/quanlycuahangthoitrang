  ...
  if($conn->query($sql)){
   ...
   if($ketQuaTruyVan->num_rows>0){
     ...
     foreach ($_SESSION['all_gio_hang'] as $item) {
       ...
       if($conn->query($sql2)){
         $sql3= "select unit_in_stock from tbl_product where product_id='".$item['0']."'";
         $ketQuaTruyVan1 = $conn->query($sql3);
         if($ketQuaTruyVan1->num_rows>0){
           $stock = $ketQuaTruyVan1->fetch_assoc();
           $sql4 ="UPDATE `tbl_product` SET `unit_in_stock`='".($stock['unit_in_stock']-$item[2])."',`unit_in_order`='".$item[2]."' WHERE product_id = '".$item[0]."'";
           $conn->query($sql4);
         }
      }
      }
    ...
    <section class="product-area product-information-area">
      <div class="container">
        <div class="product-information">
          <div class="row" >
            <div class="col-lg-12" style="justify-content: center;align-items: center;">
              ...
              <div class="edit-checkout-information" style="text-align: center; ">
