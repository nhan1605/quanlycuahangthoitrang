        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="page-title-content text-center">
              <h2 class="title text-white">Đổi mật khẩu</h2>
        ...
        <div class="row">
          <div class="col-lg-6 m-auto">
            <div class="login-form">
              <form class="login-form-wrapper form" id="login-form" action="./khach_hang_doi_mat_khau_thuc_hien.php" method="post">
                <div class="row">
                  <div class="col-lg-12">
                    <div class="section-title text-center">
                      <h2 class="title">Đổi lại mật khẩu</h2>
                    </div>
                  </div>
                </div>
               <div class="row">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-12">
                        <div class="form-group mb-0">
                          ...
                          <input class="form-control password" type="password"  placeholder="Mật khẩu cũ" required="" name="txtpassword" id="txtpassword"/>
                          <span class="form-massage"></span>
                        </div>
                      </div>
                      <div class="col-md-12">
                        <div class="form-group mb-0">
                          ...
                          <input class="form-control password" type="password" placeholder="Mật khẩu mới " required="" name="txtPassword" id="txtPassword"/>
                          <span class="form-massage"></span>
                        </div>
                      </div>
                      <div class="col-md-12">
