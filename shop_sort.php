                       ...
                       <h4 class="title"><a href="update_shop.php?id=<?=$matHang['product_id']?>"><?=$matHang['product_name']?></a></h4>
                        ...
                        <?php
                         if($matHang['promotion_id']!= null){
                          ...
                          ?>
                        <span class="price"><?=$matHang['unit_price']-$matHang['unit_price']*$promotion2['promotion_percent']/100?>VNĐ</span>
                        <del class="price-old"><?=$matHang['unit_price']?>VNĐ</del>
                        <?php
                          }
                        }else{
                          ?>
                           <span class="price"><?=$matHang['unit_price']?>VNĐ</span>
                          <?php
                        }
                        ?>
                        </div>
                        ...
                        <?php
                         if($matHang['promotion_id']!= null){
                          ...
                          if($ketQuaTruyVan2->num_rows>0){
                            $promotion2 = $ketQuaTruyVan2->fetch_assoc()
                          ?>
                        <span class="price">VNĐ<?=$matHang['unit_price']-$matHang['unit_price']*$promotion2['promotion_percent']/100?></span>
                        <del class="price-old">VNĐ<?=$matHang['unit_price']?></del>
                        <?php
                          }
                        }else{
                          ?>
                           <span class="price">VNĐ<?=$matHang['unit_price']?></span>
                          <?php
                        }
                        ?>
