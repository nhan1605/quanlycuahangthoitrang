        ...
        <div class="row flex-row-reverse e">
          <div class="col-lg-9">
                  ...
                  <div class="collection-shorting">
                    ...
                    <div class="product-sorting-wrapper">
                      <div class="product-show">
                        ...
                        <input name ="Sort" tyle="background-color:#f4a460; color: #fff; align-items: center;" width="100%" height="50px" type="submit" class="btn form-input-item" value="Lọc">
              ...
              <div class="tab-pane fade show active" id="nav-grid" role="tabpanel" aria-labelledby="nav-grid-tab">
                ...
                <?php
                    $query = "SELECT *,tbl_brand.brand_name 
                              ...
                              on tbl_product.brand_id = tbl_brand.brand_id LIMIT 
            ...
            <?php
                  ...
                  if($page>=2)
                  {
                      echo "<li> <a class='page-number' href='shop_product.php?page=".($page-1)."'>  Prev </a> </li>";
                  }
                  for ($i=1; $i<=$total_pages; $i++)
                  {
                  if ($i == $page) {
                  $pagLink .= "<li> <a class='page-number active' href='shop_product.php?page=".$i."'>".$i." </a> </li>";
                  }
                  else  {
                  $pagLink .= "<li> <a class='page-number' href='shop_product.php?page=".$i."'>".$i." </a></li>";
                  }
                  };
                  echo $pagLink;
                  if($page<$total_pages){
                  echo "<li><a class='page-number' href='shop_product.php?page=".($page+1)."'>  Next </a></li>";
                  }
                  ?>
                  </ul>
              </nav>
            ...
            <div class="widget">
                ...
                <div class="widget-categories-menu">
                  <ul>
                    ...
                    <li >
                      <a href="./shop_product.php">Sản phẩm</a>
