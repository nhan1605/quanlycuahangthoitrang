              ...
              <table>
                ...
                if(isset($_SESSION['login_user']) && $_SESSION['login_user'] == 1){
                  if($_SESSION['gio_hang']['tong_so']==0){
                    ...
                    <td class="pro-price ">$<span class="price"><?=$item[6]?></span></td>
                    ...
                    <td class="pro-subtotal">$<span class=" total-price"><?=$thanh_tien?></span></td>
                  ...
                  <tr>
                    <td colspan="4"></td>
                    <td>Tổng tiền</td>
                    <td>$<span class="total"> <?=$tong_tien?></span></td>
                  </tr>
                  <tr>
                    <td colspan="4"></td>
                    <td colspan="2">
