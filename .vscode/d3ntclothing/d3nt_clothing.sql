...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th1 11, 2023 lúc 07:57 PM
...
(5, 'Áo sơ mi cơ bản form oversize', 1, 1, 200000, 100, 0, 'áo sơ mi cơ bản form oversize.webp', '<p>- Áo sơ mi form oversize basic thoải mái. Màu sắc nhẹ nhàng. Có thể mặc thường hoặc khoác ngoài đều được.<br />\r\n- Vải kate silk ít nhăn, chấ', 3, 1, '2022-12-06', 3),
...
(12, 'SƠ MI TƠ ĐEN CỔ V', 1, 1, 300000, 100, 0, 'sơ mi tơ đen cổ chữ V.jpg', '<p>Thiết kế &aacute;o sơ mi tơ đen mềm mại, sang trọng, phần cổ phối trắng thanh lịch v&agrave; l&ocirc;i cuốn. Tr&ecirc;n nền chất liệu tơ chọn lọc cao cấp, &aacute;o được nhấn nh&aacute; th&ecirc;m ', 3, 1, '2023-01-06', NULL),
(13, 'VEST ĐEN LỬNG TAY DÀI', 1, 6, 400000, 100, 0, 'vest đen lửng tay dài.jpg', '<p>Thiết kế vest đen lửng tay d&agrave;i sang trọng, tối giản m&agrave; tinh tế, thời thượng. Tr&ecirc;n nền chất liệu tuytsi chọn lọc cao cấp, &aacute;o được nhấn nh&aacute; th&ecirc;m bằng h&agrave;', 5, 3, '2023-01-08', NULL),
...
(22, 'QUẦN TÂY - QST220507R2-N', 3, 3, 200000, 100, 0, 'Quần tây - QRT23885R2-N.jpg', '<p>Chất liệu Nano mềm mại tho&aacute;ng m&aacute;t, đứng form d&aacute;ng.<br />\r\nThiết kế form slimfit thanh lịch, th&iacute;ch hợp diện mặc khi tới c&ocirc;ng sở, dự sự kiện.<br />\r\nTone m&agrave;u ', 5, 2, '2023-01-09', 3),
...
(38, 'QUẦN DÀI KAKI NAM DOBBY FORM SLIM CROP', 5, 3, 0, 0, 0, 'QUẦN DÀI KAKI NAM DOBBY FORM SLIM CROP.jpg', '<p>Quần D&agrave;i Khaki Dobby Slim Crop - 10F22PCA009 được l&agrave;m với chất liệu kaki gi&uacute;p cho chất vải sờ v&agrave;o d&agrave;y dặn, c&oacute; độ bền v&agrave; giữ form tốt. Được thiết kế ', 1, 4, '2023-01-10', NULL),
...
ALTER TABLE `tbl_comment`
  ...
  ADD CONSTRAINT `tbl_comment_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `tbl_status` (`status_id`);
