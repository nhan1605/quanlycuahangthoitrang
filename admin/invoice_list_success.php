...
<table class="table table-striped table-bordered">
    ...
    <tbody>
                        <?php
                            $sql="SELECT tbl_user.user_name,tbl_invoice.invoice_id,tbl_invoice.user_id,tbl_invoice.order_date,tbl_invoice.total_price, tbl_status.status_describe 
                            FROM tbl_invoice, tbl_status ,tbl_user
                            WHERE tbl_invoice.status_id = tbl_status.status_id and tbl_user.user_id = tbl_invoice.user_id
                            and tbl_status.status_describe = 'Thành công' 
                            ORDER BY invoice_id";
