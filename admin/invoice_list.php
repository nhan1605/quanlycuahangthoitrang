...
<div class="col-lg-9">
    <!--div Thêm tên -->
    <div class="title_item">DANH SÁCH ĐƠN HÀNG</div>
    <div class="scroll">
...
<table class="table table-striped table-bordered">
    ...
    <tbody>
                        <?php
                            $sql="SELECT * 
                                  FROM tbl_invoice, tbl_status, tbl_user
                                  WHERE tbl_invoice.status_id= tbl_status.status_id and tbl_invoice.user_id = tbl_user.user_id
                                  ORDER BY invoice_id";
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                        <button class="btn btn-info" id ="btn-add" value="<?php echo $donHang['invoice_id'];?>"  style="margin-bottom:10px;">Cập nhật trạng thái</button>                                    
                                </td>
                                <td>
                                       <a href="./invoice_list_xoa.php?invoice_id=<?php echo $donHang['invoice_id'];?>" class="btn btn-danger">Xóa</a>                       
                                </td>
                            </tr>
                            <?php
                                }
