          ...
          <div class="col-lg-4 col-md-6 col-sm-6">
            <div class="widget-item">
              ...
              <ul class="about-widget">
                <li><img src="./image_banner/logo.jpg" width="100px" alt=""></li>
                <li>Địa chỉ: 12 P.Chùa Bộc</li>
                <li>Giờ làm việc: 
                  <br> AM: 8:00 - 12:00 <br> PM: 14:00 - 18:00</li>
                <li>Hotline: 0981486775</li>
                <li>Email: manhdat6112002@gmail.com</li>
              </ul>
            </div>
          </div>
            ...
            <div class="widget-item widget-menu-item">
              ...
              <nav class="widget-menu-wrap">
                <ul class="nav-menu nav">
                  ...
                  <li><a href="./shop_product.php">Sản phẩm</a></li>
            ...
            <div class="widget-item">
              ...
              <nav class="widget-menu-wrap">
                <ul class="nav-menu nav">
                  ...
                  <li><a href="./huong_dan_giao_nhan.php">Hướng dẫn nhận hàng</a></li>
                  <li><a href="./dieu_khoan_dich_vu.php">Điều khoản dịch vụ</a></li>
                </ul>
              </nav>
            </div>
          </div>
          ...
          <div class="row align-items-center">
            <div class="col-12">
              <div class="widget-copyright text-center">
                <p>© 2025 - <span>D3NTCLOTHING</span>. Made with <i class="fa fa-heart"></i> by <a target="_blank" href="../index.php">Nhóm 7</a></p>
              </div>
            </div>
          </div>
        </div>
 ...
 <!--=======================Javascript============================-->
    ...
    <script>
      var heartOn = document.querySelectorAll('.action-wishlist');
      heartOn.forEach(e => {
        e.onclick = function(){
          var a = e.querySelector('.fa-heart');
            a.classList.toggle('heart-on')
        }
      });
    </script>
</body>
