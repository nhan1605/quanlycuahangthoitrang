                      ...
                      <div class="col-12">
                        <div class="content m-auto">
                          <div class="inner-content">
                            ...
                            <div class="btn-wrp">
                              <a href="./shop_product.php" class="btn-link">Shop Now</a>
                            </div>
                          </div>
                        </div>
                      </div>
      ...
      <div class="container">
        ...
        <div class="row">
            ...
            <div class="product-item">
              <div class="product-thumb">
                <a href="product_detail.php?product_id=<?=$product['product_id']?>">
                  <img class="product_img" width="300px" height="300px" src="./image-product/<?=$product['product_img']?>" alt="d3ntclothing">
                  <?php
                        if($product['unit_in_stock']==0){
                          ?>
                          <div class="ribbons">
                  ...
                  <?php
                         if($product['promotion_id']!= null){
                          ...
                          if($ketQuaTruyVan2->num_rows>0){
                            $promotion2 = $ketQuaTruyVan2->fetch_assoc()
                          ?>
                  <span class="price"><?=$product['unit_price']-$product['unit_price']*$promotion['promotion_percent']/100?>VNĐ</span>
                        <del class="price-old"><?=$product['unit_price']?>VNĐ</del>
                        <?php
                          }
                        }else{
